 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Pxxo_Zend_Translate_Adapter_Gettext extends Pxxo_Zend_Translate_Adapter {
    // Internal variables
     ...
     * @throws Pxxo_Zend_Translation_Exception
     */
    protected function _loadTranslationData($filename, $locale, array $options = array())
    {
        ...
        if (!$this->_file) {
            ...
            throw new Pxxo_Zend_Translate_Exception('Error opening translation file \'' . $filename . '\'.');
        }
        if (@filesize($filename) < 10) {
            require_once 'Pxxo/Zend/Translate/Exception.php';
            throw new Pxxo_Zend_Translate_Exception('\'' . $filename . '\' is not a gettext file');
        }
