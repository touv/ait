 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Pxxo_Zend_Translate_Adapter_Xliff extends Pxxo_Zend_Translate_Adapter {
    // Internal variables
    private $_file        = false;
    ...
    protected function _loadTranslationData($filename, $locale, array $options = array())
    {
        ...
        if (!is_readable($filename)) {
            ...
            throw new Pxxo_Zend_Translate_Exception('Translation file \'' . $filename . '\' is not readable.');
        }
        ...
        if (!xml_parse($this->_file, file_get_contents($filename))) {
            ...
            require_once 'Pxxo/Zend/Translate/Exception.php';
            throw new Pxxo_Zend_Translate_Exception($ex);
        }
    }
