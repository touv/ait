 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Pxxo_Zend_Cache_Frontend_Class extends Pxxo_Zend_Cache_Core
{
    ...
    public function __construct($options = array())
    {
        ...
        if (is_null($this->_specificOptions['cached_entity'])) {
            Pxxo_Zend_Cache::throwException('cached_entity must be set !');
        } else {
            if (!is_string($this->_specificOptions['cached_entity']) && !is_object($this->_specificOptions['cached_entity'])) {
                Pxxo_Zend_Cache::throwException('cached_entity must be an object or a class name');
            }
        }
