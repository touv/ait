...
class Pxxo_Zend_Locale {
    ...
    public function __construct($locale = null)
    {
        if (empty(self::$_auto)) {
            ...
            if (empty($locale) and empty(self::$_auto) and empty(self::$_Default)) {
                ...
                throw new Pxxo_Zend_Locale_Exception('Autodetection of Locale has been failed!');
            }
        }
    ...
    public static function setDefault($locale)
    {
        if (($locale == "auto") or ($locale == "root") or 
            ...
            require_once 'Pxxo/Zend/Locale/Exception.php';
            throw new Pxxo_Zend_Locale_Exception('Only full qualified locales can be used as default!');
        }
        ...
        require_once 'Pxxo/Zend/Locale/Exception.php';
        throw new Pxxo_Zend_Locale_Exception("Unknown locale '$locale' can not be set as default!");
    }
    ...
    {
        require_once 'Pxxo/Zend/Locale/Data/Translation.php';
        ...
        foreach ($languages as $locale) {
            ...
            if ($language != 'C') {
                ...
                if (!empty(Pxxo_Zend_Locale_Data_Translation::$localeTranslation[$splitted[0]])) {
                    if (!empty(Pxxo_Zend_Locale_Data_Translation::$localeTranslation[$splitted[1]])) {
                        $languagearray[Pxxo_Zend_Locale_Data_Translation::$localeTranslation[$splitted[0]] . '_'
                      . Pxxo_Zend_Locale_Data_Translation::$localeTranslation[$splitted[1]]] = 1;
                    }
                    $languagearray[Pxxo_Zend_Locale_Data_Translation::$localeTranslation[$splitted[0]]] = 1;
                }
            }
        }
    ...
    public function getTranslationList($path = null, $locale = null, $value = null)
    {
        ...
        $result = Pxxo_Zend_Locale_Data::getList($locale, $path, $value);
        if (empty($result)) {
            return false;
        }
        return $result;
    ...
    public function getTranslation($value = null, $path = null, $locale = null)
    {
        ...
        $result = Pxxo_Zend_Locale_Data::getContent($locale, $path, $value);
        if (empty($result)) {
            return false;
        }
        return $result;
    ...
    public function getQuestion($locale = null)
    {
        ...
        $quest = Pxxo_Zend_Locale_Data::getList($locale, 'question');
     ...
     *
     * @param  string|Pxxo_Zend_Locale  $locale  Locale to check for
     ...
     * Sets a cache
     *
     * @param Pxxo_Zend_Cache_Core $cache
     */
    public static function setCache(Pxxo_Zend_Cache_Core $cache)
    {
        // load class within method for speed
        require_once 'Pxxo/Zend/Locale/Data.php';
        Pxxo_Zend_Locale_Data::setCache($cache);
    }
}
